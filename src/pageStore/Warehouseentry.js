        ...
        <div className="container-fuild">
            ...
            <div className="row">
                <div className="col-md-2 c-12 menu-trai">
                    ...
                    <div className="MenuRow danhmuc-thuonghieu">
                        <select className="form-control MenuRow">
                            <option>Kiểm kho</option>
                            <option>Danh sách phiếu kiểm kho</option>
                            <option>Sản phẩm</option>
                        </select>
                    </div>
                    <div className=" MenuRow sanpham pt-2 pb-2">
                        Lịch sử xóa
      </div>
                </div>
                <div className="col-md-10 c-12 menu_phai">
                    ...
                    <ul className="nav nav-tabs mt-2">
                        <li className="nav-item">
                            <a className="nav-link active MenuRow1" href="/Warehouseentry"> <i className="fa fa-edit pr-2" />Phiếu nhập kho</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link MenuRow" href="/Outofstock"><i className="fa fa-edit pr-2" />Phiếu xuất kho</a>
                        </li>
                    </ul>
                    {/* themsanpham */}
