            ...
            <div className="row">
                <div className="col-md-2 c-12 menu-trai">
                    <div className="sanpham MenuRow1 pt-2 pb-2">
                        <a className="MenuRow1" href="/Billofsale"> <i className="fa fa-cube" />Hóa đơn bán</a>
                    </div>
                    <div className="sanpham  pt-2 pb-2">
                         <a className="MenuRow" href="/Billofreturn"> <i className="fa fa-cube" /> Hóa đơn trả hàng</a>
                    </div>
                </div>
