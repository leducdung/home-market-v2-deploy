...
function Correctentryprice() {
    return (
        <div className="Correctentryprice">
            <Menustore></Menustore>
            <div className="container-fuild ">
                <div className="row">
                    ...
                    <div className="col-md-10 c-12 menu_phai mb-5">
                        {/* thanhcongcu */}
                            ...
                            <table className="table table-bordered table-responsive-sm">
                                <thead className="thead-dark">
                                    <tr>
                                        ...
                                        <th scope="col">Gía nhập cũ</th>
                                        <th scope="col">Gía nhập mới</th>
...
export default Correctentryprice;